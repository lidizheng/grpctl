...
func inspectCommandRunWithError(cmd *cobra.Command, args []string) error {
...
var inspectCmd = &cobra.Command{
	...
	Args:  cobra.NoArgs,
	RunE:  inspectCommandRunWithError,
}

func inspectChannelCommandRunWithError(cmd *cobra.Command, args []string) error {
...
var inspectChannelCmd = &cobra.Command{
	Use:   "channel",
	Short: "Display channel states in human readable way.",
	Args:  cobra.ExactArgs(1),
	RunE:  inspectChannelCommandRunWithError,
}

func inspectSubchannelCommandRunWithError(cmd *cobra.Command, args []string) error {
	var idOrTarget string = args[0]
...
var inspectSubchannelCmd = &cobra.Command{
	Use:   "subchannel",
	Short: "Display subchannel states in human readable way.",
	Args:  cobra.ExactArgs(1),
	RunE:  inspectSubchannelCommandRunWithError,
}

func init() {
	inspectCmd.AddCommand(inspectChannelCmd)
	inspectCmd.AddCommand(inspectSubchannelCmd)
